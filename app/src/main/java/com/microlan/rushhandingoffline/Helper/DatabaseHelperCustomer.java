...
public class DatabaseHelperCustomer extends SQLiteOpenHelper {
    ...
    private static final String COL4 = "Customer_Address";
    ...
    public boolean addData(String Customer_Name, String Customer_Mobile, String Customer_Address) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(COL2, Customer_Name);
        contentValues.put(COL3, Customer_Mobile);
        contentValues.put(COL4, Customer_Address);
