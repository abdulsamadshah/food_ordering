...
public class DatabaseHelperProductQty extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "POSDB";
    private static final String TAG = "DatabaseHelper";

    private static final String TABLE_NAME = "POSTableQty";
    private static final String COL1 = "ID";
    private static final String COL2 = "barcode_id";
    private static final String COL3 = "product_name";
    private static final String COL4 = "product_qty";
    //private static final String COL5 = "description";


    public DatabaseHelperProductQty(Context context) {
     ...
     * @param ProductName
     */
    public void UpdateProduct(String ProductName, String NewQty){
        SQLiteDatabase db = this.getWritableDatabase();
        String query = "UPDATE " + TABLE_NAME + " SET " + COL4 +
                " = '" + NewQty + "' WHERE " + COL3 + " = '" + ProductName + "'";
