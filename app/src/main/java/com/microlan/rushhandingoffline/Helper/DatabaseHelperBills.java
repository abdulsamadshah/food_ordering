...
public class DatabaseHelperBills extends SQLiteOpenHelper {
    ...
    private static final String COL2 = "BillDate";
    private static final String COL3 = "Customer_Name";
    private static final String COL4 = "Amount";
    //private static final String COL5 = "description";


    public DatabaseHelperBills(Context context) {
    ...
    public boolean addData(String BillDate, String Customer_Name, String Amount) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(COL2, BillDate);
        contentValues.put(COL3, Customer_Name);
