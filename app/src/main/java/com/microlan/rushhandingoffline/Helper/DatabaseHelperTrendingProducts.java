...
public class DatabaseHelperTrendingProducts extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "POSDB";
    private static final String TAG = "DatabaseHelper";

    private static final String TABLE_NAME = "TrendingProductsTable";
    ...
    public DatabaseHelperTrendingProducts(Context context) {
