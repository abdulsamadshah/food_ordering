...
public class OrderHistoeryAdapter extends BaseAdapter {
    Context context;
    ArrayList<String> UserName, OrderNumber, TotalAmount, Address, DateTime,walletAmount,discount,cashAmount,paymentMode,orderid;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        order_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ProductsOrderIntent.putExtra("TotalAmount",Balance.get(position));
