...
*/
    ...
    private void addaddresslist(final ArrayList<String> customerID, final ArrayList<String> customerName, final ArrayList<String> customerMObile, final ArrayList<String> customerEmail, final ArrayList<String> arrayAddres1, final ArrayList<String> arrayAddress2, final ArrayList<String> arrayCity, final ArrayList<String> customerState, final ArrayList<String> arrayPin, final ArrayList<String> arrayuniqeid)
    {
        ...
        if(customerID==null) { }
        else{ for (int i = 0; i < customerID.size(); i++){
        ...
        else{ for (int i = 0; i < customerName.size(); i++){
        ...
        else{ for (int i = 0; i < customerMObile.size(); i++){
        ...
        else{ for (int i = 0; i < customerEmail.size(); i++){
  ...
  if(arrayAddres1==null) { }
        else{ for (int i = 0; i < arrayAddres1.size(); i++){
            String TempDimen = customerEmail.get(i);
  ...
  if(arrayAddress2==null) { }
        else{ for (int i = 0; i < arrayAddress2.size(); i++){
  ...
  if(arrayCity==null) { }
        else{ for (int i = 0; i < arrayCity.size(); i++){
  ...
  if(customerState==null) { }
        else{ for (int i = 0; i < customerState.size(); i++){
  ...
  if(arrayPin==null) { }
        else{ for (int i = 0; i < arrayPin.size(); i++){
  ...
  if(arrayuniqeid==null) { }
        else{ for (int i = 0; i < arrayuniqeid.size(); i++){
        ...
        String insertUrl = "http://microlanpos.com/demo/api2/syncCustomerAddressTable";
        ...
        StringRequest request = new StringRequest(Request.Method.POST, insertUrl, new com.android.volley.Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Log.d("sdfsdfd","ssdddddadd "+error.toString());
                //   progressDialog.cancel();
...
if(customerState==null)
 ...
 if(arrayuniqeid==null)
    ...
    private void addcustomer(final ArrayList<String> customerID, final ArrayList<String> customerName, final ArrayList<String> customerMObile, final ArrayList<String> customerEmail, final ArrayList<String> customeruniqe)
    {
        ...
        else{ for (int i = 0; i < customeruniqe.size(); i++){
        ...
        String insertUrl = "http://microlanpos.com/demo/api2/syncCustomerTable";
        //  String insertUrl = "https://papasmart.online/api2/syncOrderDataDetailsTable";
        StringRequest request = new StringRequest(Request.Method.POST, insertUrl, new com.android.volley.Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(MainActivity.this, error.toString(), Toast.LENGTH_SHORT).show();
                System.out.print(error.toString());
                Log.d("sdfsdfd","ssssssadd "+error.toString());
                //   progressDialog.cancel();
         ...
         if(customeruniqe==null)
                ...
                Log.d("dsssssa","Customer Data "+parameters);
    ...
    private void addOrderdetails(final ArrayList<String> orderid, final ArrayList<String> orderNumber, final ArrayList<String> user_id, final ArrayList<String> productId, final ArrayList<String> productName, final ArrayList<String> orderProductPrice, final ArrayList<String> productQuantity, final ArrayList<String> size, final ArrayList<String> packsize, final ArrayList<String> unit, final ArrayList<String> color, final ArrayList<String> inglePrice)
    {
        ...
        if(user_id==null) { }
        else{ for (int i = 0; i < user_id.size(); i++){
        ...
        if(orderNumber==null) { }
        else{ for (int i = 0; i < orderNumber.size(); i++){
        ...
        if(orderid==null) { }
        else{ for (int i = 0; i < orderid.size(); i++){
        ...
        if(productId==null) { }
        else{ for (int i = 0; i < productId.size(); i++){
        ...
        if(productName==null) { }
        else{ for (int i = 0; i < productName.size(); i++){
        ...
        else{ for (int i = 0; i < orderProductPrice.size(); i++){
        ...
        else{ for (int i = 0; i < productQuantity.size(); i++){
        ...
        if(packsize==null) { }
        else{ for (int i = 0; i < packsize.size(); i++){
        ...
        if(unit==null) { }
        else{ for (int i = 0; i < unit.size(); i++){
        ...
        if(color==null) { }
        else{ for (int i = 0; i < color.size(); i++){
        ...
        if(inglePrice==null) { }
        else{ for (int i = 0; i < inglePrice.size(); i++){
        ...
        String insertUrl = "http://microlanpos.com/demo/api2/syncOrderDataDetailsTable";
      //  String insertUrl = "https://papasmart.online/api2/syncOrderDataDetailsTable";
        StringRequest request = new StringRequest(Request.Method.POST, insertUrl, new com.android.volley.Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(MainActivity.this, error.toString(), Toast.LENGTH_SHORT).show();
                System.out.print(error.toString());
                Log.d("sdfsdfd","addsssss "+error.toString());
                //   progressDialog.cancel();
    ...
    private void addorderlist(final ArrayList<String> user_id, final ArrayList<String> orderNumber, final ArrayList<String> paymentMode, final ArrayList<String> address, final ArrayList<String> totalAmount, final ArrayList<String> userName, final ArrayList<String> customer_id, final ArrayList<String> walletAmount, final ArrayList<String> discount, final ArrayList<String> discout_type, final ArrayList<String> cashAmount, final ArrayList<String> order_type, final ArrayList<String> dateTime, final ArrayList<String> CGST, final ArrayList<String> SGST, final ArrayList<String> IGST)
    {
        ...
        if(CGST==null) { }
        else{ for (int i = 0; i < CGST.size(); i++){
        ...
        if(SGST==null) { }
        else{ for (int i = 0; i < SGST.size(); i++){
        ...
        if(IGST==null) { }
        else{ for (int i = 0; i < IGST.size(); i++){
        ...
        if(paymentMode==null) { }
        else{ for (int i = 0; i < paymentMode.size(); i++){
        ...
        if(address==null) { }
        else{ for (int i = 0; i < address.size(); i++){
        ...
        if(totalAmount==null) { }
        else{ for (int i = 0; i < totalAmount.size(); i++){
        ...
        if(userName==null) { }
        else{ for (int i = 0; i < userName.size(); i++){
        ...
        if(customer_id==null) { }
        else{ for (int i = 0; i < customer_id.size(); i++){
        ...
        else{ for (int i = 0; i < walletAmount.size(); i++){
        ...
        if(discount==null) { }
        else{ for (int i = 0; i < discount.size(); i++){
        ...
        else{ for (int i = 0; i < discout_type.size(); i++){
        ...
        if(cashAmount==null) { }
        else{ for (int i = 0; i < cashAmount.size(); i++){
        ...
        if(order_type==null) { }
        else{ for (int i = 0; i < order_type.size(); i++){
        ...
        if(dateTime==null) { }
        else{ for (int i = 0; i < dateTime.size(); i++){
       ...
       // String insertUrl = "https://papasmart.online/api2/syncOrderDataTable";
        String insertUrl = "http://microlanpos.com/demo/api2/syncOrderDataTable";
        StringRequest request = new StringRequest(Request.Method.POST, insertUrl, new com.android.volley.Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
              //  progressDialog.cancel();
